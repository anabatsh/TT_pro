...
def protes_jax(f, n, M, K=50, k=5, k_gd=100, r=5, lr=1.E-4, sig=None, M_ANOVA=None, batch=False, with_cache=False, with_qtt=False, is_rand_init=True, log=False, log_ind=False, constr=False):
