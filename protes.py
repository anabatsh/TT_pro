...
def protes(f, d, n, M, K=20, k=1, k_gd=10, r=5, lr=1.E-4, sig=None, M_ANOVA=None, batch=False, with_cache=False, with_qtt=False, is_rand_init=True, log=False, log_ind=False, constr=False):
